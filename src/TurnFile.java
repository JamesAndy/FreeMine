...
public class TurnFile {
    ...
    //參數設定:起始目錄
    private final static String startPath = "D:/Wezoomtek/ntpc/swjweb/src";
    //參數設定:篩選檔案
    private final static String pFilter = ".properties";
    //參數設定:取代路徑
    private final static String replacePath = "D:/Wezoomtek/ntpc/swjweb/";
    //參數設定:目的路徑
    private final static String purposePath = "E:/Desktop/swjweb/src";
